...
def playGame(wordList):
    ...
    while True:
      user = str(input("Enter 'n' to deal a new hand, 'r' to play the last hand again, 'e' to exit the game: ")
      if user == 'e':
         break
      elif user == 'n':
         ...
         try:
            ...
            print("You haven't played a hand yet. Please make a deal first.")
      else:
