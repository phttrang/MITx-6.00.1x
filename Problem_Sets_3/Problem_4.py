...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the
    ...
    print("The number of letters the secret word contains: ", str(len(secretWord)))
    print("You should only supply one guess per round!!!!")
    mistakeMade = 0
    lettersGuessed = []
    ...
    while 8 - mistakeMade > 0:
      if isWordGuessed(secretWord, lettersGuessed) == True:
        ...
        print("You have ", 8 - mistakeMade, " left")
        ...
        if guess in secretWord and guess not in lettersGuessed:
          ...
          print("You've already guessed that letter, try again: ", getGuessedWord(secretWord, lettersGuessed))
