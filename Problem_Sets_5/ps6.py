    ...
    def apply_shift(self, shift):
        ...
        for letter in self.message_text:
            if letter in newDict:
                newMessage.append(newDict[letter])
            else:
...
class PlaintextMessage(Message):
    def __init__(self, text, shift):
        ...
        self.shift = shift
        self.ecryption_dict = Message.build_shift_dict(self, shift)
    ...
    def get_encryption_dict(self):
        ...
        '''
        ecryption_dict_copy = self.ecryption_dict.copy()
        return ecryption_dict_copy
    ...
    def change_shift(self, shift):
        ...
        '''
        self.shift = shift
        self.ecryption_dict = super(PlaintextMessage(self)).build_shift_dict(shift)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        best_message = ""
        for i in range(26):
            shifted_message = Message.apply_shift(self, i).split(" ")
            word_count = 0
            ...
            if word_count > max_count:
                ...
                best_shift = i
                best_message = Message.apply_shift(self, i)
